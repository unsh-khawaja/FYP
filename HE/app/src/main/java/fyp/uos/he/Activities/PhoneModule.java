...
public class PhoneModule extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_module);
        ...
        hlp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                VoiceSearchActivity.module = "phone";
                startActivity(new Intent(PhoneModule.this, HelpActivity.class));
            }
        });
    }
...
//            VoiceSearchActivity.module = "phone";
//            Intent intent=new Intent(HelpActivity.class);
//            intent.show(getActi(), null);
         else
